    ...
    <form class="mt-6" @submit.prevent="validate">
        ...
        <div class="mt-4 lg:flex lg:justify-between">
            ...
            <div class="lg:w-full lg:mr-3">
                ...
                <input id="" type="text" :value="allianzdata.lastname === '' ? user.lastname : allianzdata.lastname" @change="(e) => allianzdata.lastname = e.target.value "
            ...
            <div class="lg:w-full lg:mr-3">
                ...
                <input id="Telephone" type="text" :value="allianzdata.firstname === '' ? user.firstname : allianzdata.firstname" @change="(e) => allianzdata.firstname = e.target.value "
                    class="block mt-4 bg-blue-100 px-4 py-2 w-full outline-none focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    >
            </div>
        </div>
...
<!--            </div>-->
        ...
        <div class="mt-4 lg:flex lg:justify-between">
            ...
            <div class="lg:w-full lg:mr-3">
                ...
                <input type="text" :value="allianzdata.address === '' ? user.address : allianzdata.address" @change="(e) => allianzdata.address = e.target.value "
                    class="block mt-4 bg-blue-100 px-4 py-2 w-full outline-none focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    >
            </div>
        ...
        <transition name="scale">
            <ReviewModal v-if="showReviewModal" v-on:useCard="payWithCard" tett="managetravel" />
        </transition>
...
export default {
    ...
    methods: {
        ...
        validate() {
            ...
            let data = {
                    "firstname": this.allianzdata.firstname === '' ? this.user.firstname : this.allianzdata.firstname,
                    "lastname": this.allianzdata.lastname === '' ? this.user.lastname : this.allianzdata.lastname,
                    ...
                    "address": this.allianzdata.address === '' ? this.user.address : this.allianzdata.address,
      ...
      validatePhoneNumber(phoneNumber) {
        ...
        this.allianzdata.next_of_kin_phone = phoneNumber
      ...
      validatePassportNo(value) {
        ...
        if (regex.test(value)) {
          // Valid format, update the data
          this.allianzdata.passport_no = value.toUpperCase(); // Convert to uppercase if needed
          this.error.passportNo = ""
        } else {
          // Invalid format, handle accordingly (show an error message, etc.)
          // For now, you can clear the input
          this.allianzdata.passport_no = '';
